...
namespace UdemyCarBook.Persistence.Context
{
    public class CarBookContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=MUHAMMETALI45\\SQLEXPRESS;initial Catalog=(404-Udemy)OnionArcCarBookDb;integrated Security=true;TrustServerCertificate=true;");
